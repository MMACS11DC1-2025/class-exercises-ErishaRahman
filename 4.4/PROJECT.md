...
- [2] Proper turtle setup and configuration (2 pts)
- [2] Function actually draws visual patterns using turtle commands (2 pts)
- [2] Visual output demonstrates recursive concepts effectively (2 pts)

### **Code Quality**
- [2] Code is well-organized, readable, and follows Python naming conventions. (2 pts)
- [2] Includes meaningful comments that explain the logic and steps taken in the code. (2 pts)
...
### **Peer Review**
- [2] Peer review completed with classmate. Feedback on code quality, approach, and any debugging techniques used are documented in README (2 pts)
