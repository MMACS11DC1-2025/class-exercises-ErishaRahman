...
# input test 1: enter 20, "FireBoy", enter "lighter" ==> small red flower, light brown stem, green leaves
# input test 2: enter 40, "WaterGirl", enter "darker" ==> medium blue flower, black stem, green leaves
# input test 3: enter 100, "FireBoy", enter "lighter" ==> very large red flower, light brown stem, green leaves
# input test 4: enter 30, "watergirl", enter "darker" ==> medium blue flower, black stem, green leaves (tests lower.())
# input test 5: enter 20, "fireboy", enter "lighter" ==> small red flower, light brown stem, green leaves (tests min size)
